...
### Not Gate Diagram
![Not Gate Diagram](../static/01-boolean-logic/not-gate.png)
...
| 1 | 1 | 1 |
### And Gate Diagram
![And Gate Diagram](../static/01-boolean-logic/and-gate.png)
...
### Or Gate Diagram
![Or Gate Diagram](../static/01-boolean-logic/or-gate.png)
...
### Xor Gate Diagram
![Xor Gate Diagram](../static/01-boolean-logic/xor-gate.png)
...
### Mux Gate Diagram
![Mux Gate Diagram](../static/01-boolean-logic/multiplexer-gate.png)
...
### DMux Gate Diagram
![DMux Gate Diagram](../static/01-boolean-logic/demultiplexer-gate.png)